...
// buckets are unchanged: 6^3 = 216 states for each of the two three-question
// buckets, and 6^4 = 1,296 for each of the three four-question scale
// buckets. 2*6^3 (Communication, Growth) + 3*6^4 (Finances, Relationship,
// Delivery) + 3^4 (Advocacy) = 432 + 3,888 + 81 = 4,401 states -- fewer than
// the 5,616 the pre-step-2.5 version checked, and still exhaustive -- every
...
// per bucket rather than 6^22 across the table.
